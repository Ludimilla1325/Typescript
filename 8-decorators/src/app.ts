...
interface ValidatorConfig { //Thats the configuration of storage
...
function Required(target: any, propName: string){
    ...
    ...registeredValidators[target.constructor.name], // Thats to not overwritte the registered validators for a given class name with a new object
        [propName] : ['required']
    };
}
...
let isValid = true; // with that, we ensure that all properties are checked and not just the first one
